...
function Login() {
    ...
    return (
        <div style={{ 
            ...
            <div style={{ flex: 1, position: "relative", display: "flex", flexDirection: "column", justifyContent: "center", padding: "80px", color: "white" }}>
            ...
            <div style={{ width: "100%", maxWidth: "500px", background: "#ffffff", display: "flex", flexDirection: "column", justifyContent: "center", padding: "60px 50px", boxShadow: "-10px 0 40px rgba(0,0,0,0.15)", zIndex: 10, position: "relative" }}>
                
                <div style={{ textAlign: "center", marginBottom: "35px" }}>
                    <img src={logoSurgiFlow} alt="SurgiFlow Logo" style={{ height: "190px", objectFit: "contain", marginBottom: "10px" }} onError={(e) => { e.target.style.display = 'none' }} />
                ...
                {!isRecovering ? (
                    <form onSubmit={handleLogin} style={{ display: "flex", flexDirection: "column", gap: "18px" }}>
                        ...
                        <div style={{ position: "relative" }}>
                            ...
                            {/* O input muda o tipo baseado no estado mostrarSenha */}
                            <input 
                            ...
                            {/* Botão invisível do olhinho, posicionado no canto direito */}
                            <button
                                type="button"
