...
import { X, User, FileText, Phone, Mail, Calendar, MapPin } from "lucide-react";
...
function PacienteModal({ isOpen, onClose, onSave, paciente }) {
    ...
    // Preenche o formulário se for edição, ou limpa se for cadastro novo
    useEffect(() => {
        if (paciente) {
            setForm(paciente);
        } else {
    ...
    // Máscaras para facilitar a digitação da equipe
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <h2 style={{ margin: 0, fontSize: "1.25rem", color: "#1e293b", fontWeight: "700" }}>
                        {paciente ? "Editar Ficha do Paciente" : "Novo Paciente"}
                    </h2>
                ...
                <form onSubmit={handleSubmit} style={{ padding: "25px", display: "flex", flexDirection: "column", gap: "16px" }}>
                    ...
                    <div style={{ position: "relative" }}>
                        ...
                        <input type="text" name="nome" placeholder="Nome completo do paciente" value={form.nome} onChange={handleChange} required style={inputStyle} />
                    </div>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
                        ...
                        <div style={{ position: "relative" }}>
                            ...
                            <input type="date" name="data_nascimento" value={form.data_nascimento} onChange={handleChange} style={inputStyle} title="Data de Nascimento" />
                        </div>
                    </div>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
                        <div style={{ position: "relative" }}>
                            ...
                            <input type="text" name="telefone" placeholder="WhatsApp (Celular)" value={form.telefone} onChange={handleChange} required style={inputStyle} />
                        </div>
                        <div style={{ position: "relative" }}>
                    ...
                    <div style={{ position: "relative" }}>
                        ...
                        <input type="text" name="endereco" placeholder="Endereço completo (Opcional)" value={form.endereco} onChange={handleChange} style={inputStyle} />
                    </div>
